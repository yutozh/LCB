...
module.exports.connect = function (connectString, cb) {
	...
	var sql = [
		...
		// MY LC 学习社区列表
		"CREATE TABLE IF NOT EXISTS lcs(username VARCHAR(20) NOT NULL, transactionId VARCHAR(20) NOT NULL, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",
		...
		// MY LC 学习社区授权情况
    "CREATE TABLE IF NOT EXISTS lc_auth(lc_auth TEXT, transactionId VARCHAR(20) NOT NULL, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",

    // MY LC 学习社区投票情况
		"CREATE TABLE IF NOT EXISTS lc_votes(lc_votes TEXT, transactionId VARCHAR(20) NOT NULL, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",
